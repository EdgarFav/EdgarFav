...
Como Full Stack Web Developer, estoy muy entusiasmado de utilizar mis habilidades técnicas para desarrollar soluciones innovadoras y eficientes. Tengo firmes conocimientos de Javascript, React, Next, Node.js, SQL y NoSQL. 💻

Estoy muy entusiasmado por aplicar mis habilidades y conocimientos para lograr un impacto significativo en la industria de la tecnología. Abierto a aprender nuevas tecnologías, así como también a adaptarme a la cultura de trabajo de donde me encuentre.

Si estás buscando un Desarrollador Backend, Front End o Full Stack con una sólida formación técnica y pasión por crear cosas geniales, no dudes en ponerte en contacto conmigo y empezar a trabajar juntos para lograr grandes resultados.   
...
<a href="https://expressjs.com/" target="_blank"><img style="margin: 10px, "background-color: white" src="https://profilinator.rishav.dev/skills-assets/express-original-wordmark.svg" alt="Express.js" height="40" /></a>  
